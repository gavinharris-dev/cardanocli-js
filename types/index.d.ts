...
declare class CardanocliJs {
  ...
  queryTxIdUtxo(txId: string): object;
   ...
   * @returns {path}
   */
  transactionSign(options: { signingKeys: Array<path>; txBody: path }): path;
  /**
   *
   * @param {Object} options
   * @param {path} options.txBody
   ...
   * @returns {path}
   */
  transactionWitness(options: { txBody: path; signingKey: path }): path;
  /**
   *
   * @param {Object} options
   * @param {path} options.txBody
